...
<html>
	...
	<hr>
		...
		local NativeActionListener = require 'java.tests.java-asm.nativeactionlistener_asm'(J)
...
local NativeRunnable = require 'java.tests.java-asm.nativerunnable_asm'(J)	-- use ASM, make sure you load all of them here
