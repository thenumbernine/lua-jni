...
class ASMDynamicGenerator implements Opcodes {
    ...
    public static byte[] generateHelloWorldClass() {
        ...
        init.visitCode();
        init.visitVarInsn(ALOAD, 0); // Load 'this'
        ...
        cw.visitEnd();
        return cw.toByteArray(); // Return the bytecode as a byte array
    }
}

public class TestASM {
    public static void main(String[] args) throws Exception {
        byte[] code = ASMDynamicGenerator.generateHelloWorldClass();
