...
ffi.cdef[[
/* + BEGIN <jni.h> Android/Sdk/ndk/28.2.13676358/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/jni.h */
...
/* ++ BEGIN <stdint.h> Android/Sdk/ndk/28.2.13676358/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/stdint.h */
]] require 'ffi.req' 'c.stdint' ffi.cdef[[
/* ++ END <stdint.h> Android/Sdk/ndk/28.2.13676358/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/stdint.h */
...
enum { JNIIMPORT = 1 };
/* #define JNIEXPORT __attribute__ ((visibility ("default"))) ### define is not number */
enum { JNICALL = 1 };
enum { JNI_FALSE = 0 };
enum { JNI_TRUE = 1 };
...
local lib = {}
lib.JNIEXPORT = '__attribute__ ((visibility ("default")))'
lib.JNICALL = ''
return lib
